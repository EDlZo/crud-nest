...
var divWithClassName_default = (className) => (
  ...
  React15.forwardRef((p, ref) => (0, import_jsx_runtime10.jsx)("div", {
    ...p,
    ref,
...
var Button2 = React26.forwardRef(({
  ...
  return (0, import_jsx_runtime22.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames17.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size && `${prefix}-${size}`, props.href && disabled && "disabled")
  });
});
...
var ButtonGroup = React27.forwardRef(({
  ...
  return (0, import_jsx_runtime23.jsx)(Component2, {
    ...
    ref,
    role,
    className: (0, import_classnames18.default)(className, baseClass, size && `${prefix}-${size}`)
  });
});
...
function useTimeout() {
  ...
  const handleRef = (0, import_react27.useRef)();
...
var Carousel = (
  ...
  React44.forwardRef(({
    ...
    const nextDirectionRef = (0, import_react28.useRef)(null);
    const [direction, setDirection] = (0, import_react28.useState)("next");
    const [paused, setPaused] = (0, import_react28.useState)(false);
    const [isSliding, setIsSliding] = (0, import_react28.useState)(false);
    const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react28.useState)(activeIndex || 0);
    ...
    const prev = (0, import_react28.useCallback)((event) => {
      if (isSliding) {
        return;
      }
    ...
    const elementRef = (0, import_react28.useRef)();
    ...
    const handleEnter = (0, import_react28.useCallback)((node) => {
      triggerBrowserReflow(node);
      onSlide == null || onSlide(renderedActiveIndex, slideDirection);
    }, [onSlide, renderedActiveIndex, slideDirection]);
    const handleEntered = (0, import_react28.useCallback)(() => {
      setIsSliding(false);
      onSlid == null || onSlid(renderedActiveIndex, slideDirection);
    ...
    const handleMouseOver = (0, import_react28.useCallback)((event) => {
      if (pause === "hover") {
        setPaused(true);
      }
      onMouseOver == null || onMouseOver(event);
    }, [pause, onMouseOver]);
    const handleMouseOut = (0, import_react28.useCallback)((event) => {
      setPaused(false);
      onMouseOut == null || onMouseOut(event);
    }, [onMouseOut]);
    const touchStartXRef = (0, import_react28.useRef)(0);
    const touchDeltaXRef = (0, import_react28.useRef)(0);
    const touchUnpauseTimeout = useTimeout();
    const handleTouchStart = (0, import_react28.useCallback)((event) => {
    ...
    const handleTouchMove = (0, import_react28.useCallback)((event) => {
    ...
    const handleTouchEnd = (0, import_react28.useCallback)((event) => {
      if (touch) {
    ...
    const intervalHandleRef = (0, import_react28.useRef)();
    (0, import_react28.useEffect)(() => {
    ...
    const indicatorOnClicks = (0, import_react28.useMemo)(() => indicators && Array.from({
      length: numChildren
    }, (_, index) => (event) => {
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react29.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react29.useState)(defaultValue);
  ...
  return [isProp ? propValue : stateValue, (0, import_react29.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react30.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react31.useCallback)((nextState) => {
    if (!isMounted()) return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react32.useRef)(modifiers);
  const popperInstanceRef = (0, import_react32.useRef)();
  const update = (0, import_react32.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react32.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react32.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react32.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react32.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop2, {
  ...
  const preventMouseClickOutsideRef = (0, import_react33.useRef)(false);
  const waitingForTrigger = (0, import_react33.useRef)(false);
  const handleMouseCapture = (0, import_react33.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react34.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef2();
  const hasShownRef = (0, import_react34.useRef)(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react35.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react35.useState)(true);
  let value = (0, import_react35.useMemo)(() => ({
  ...
  return (0, import_react35.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react35.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react35.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react35.default).createElement((0, import_react35.default).Fragment, null, props.children);
  }
  return (0, import_react35.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react36.useContext)(DropdownContext_default) || {};
...
init_canUseDOM();
var Context = (0, import_react38.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react38.useContext)(Context);
}
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react39.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react39.useRef)(null);
  const focusInDropdown = (0, import_react39.useRef)(false);
  const onSelectCtx = (0, import_react39.useContext)(SelectableContext_default);
  const toggle = (0, import_react39.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context6 = (0, import_react39.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react39.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react40.useLayoutEffect : import_react40.useEffect;
...
var FormControl = React74.forwardRef(({
  ...
  return (0, import_jsx_runtime66.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames51.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormSelect = React79.forwardRef(({
  ...
  return (0, import_jsx_runtime71.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames55.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var Switch = React81.forwardRef((props, ref) => (0, import_jsx_runtime73.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var InputGroup = React85.forwardRef(({
  ...
  return (0, import_jsx_runtime78.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime78.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames60.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
function useMergedRefs(refA, refB) {
  return (0, import_react54.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
var ModalDialog = React96.forwardRef(({
  ...
  return (0, import_jsx_runtime87.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames64.default)(dialogClass, className, size && `${bsPrefix}-${size}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
...
var Pagination = React126.forwardRef(({
  ...
  return (0, import_jsx_runtime124.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames88.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames89.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var Spinner = React132.forwardRef(({
  ...
  return (0, import_jsx_runtime130.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames93.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var Table = React139.forwardRef(({
  ...
  const classes = (0, import_classnames97.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
