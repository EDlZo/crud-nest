import {
  ...
  useUncontrolledProp,
  useWillUnmount
} from "./chunk-JR536ZAF.js";
import {
  _objectSpread2
} from "./chunk-RMWC32LZ.js";
import {
  require_react_dom
...
function useGlobalListener(event, handler, capture = false) {
  const documentTarget = (0, import_react4.useCallback)(() => document, []);
  return useEventListener(documentTarget, event, handler, capture);
}

// node_modules/react-overlays/esm/DropdownContext.js
var import_react5 = __toESM(require_react());
var DropdownContext = import_react5.default.createContext(null);
...
function usePopper(referenceElement, popperElement, _temp) {
  ...
  var popperInstanceRef = (0, import_react7.useRef)();
  var update = (0, import_react7.useCallback)(function() {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  var forceUpdate = (0, import_react7.useCallback)(function() {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  var _useSafeState = useSafeState_default((0, import_react7.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  var updateModifier = (0, import_react7.useMemo)(function() {
    return {
...
function useRootClose(ref, onRootClose, _temp) {
  ...
  var handleMouseCapture = (0, import_react8.useCallback)(function(e) {
    var _e$composedPath$;
...
function useDropdownMenu(options) {
  ...
  var context = (0, import_react9.useContext)(DropdownContext_default);
  var _useCallbackRef = useCallbackRef(), arrowElement = _useCallbackRef[0], attachArrowRef = _useCallbackRef[1];
  var hasShownRef = (0, import_react9.useRef)(false);
...
function DropdownMenu(_ref2) {
  ...
  return import_react9.default.createElement(import_react9.default.Fragment, null, meta.hasShown ? children(props, meta) : null);
}
...
function useDropdownToggle() {
  var _ref = (0, import_react10.useContext)(DropdownContext_default) || {}, _ref$show = _ref.show, show = _ref$show === void 0 ? false : _ref$show, _ref$toggle = _ref.toggle, toggle = _ref$toggle === void 0 ? noop5 : _ref$toggle, setToggle = _ref.setToggle;
  var handleClick = (0, import_react10.useCallback)(function(e) {
    toggle(!show, e);
  }, [show, toggle]);
  return [{
    ref: setToggle || noop5,
...
function DropdownToggle(_ref2) {
  ...
  return import_react10.default.createElement(import_react10.default.Fragment, null, children(props, meta));
}
...
function useRefWithUpdate() {
  ...
  var attachRef = (0, import_react11.useCallback)(function(element) {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown(_ref) {
  ...
  var lastSourceEvent = (0, import_react11.useRef)(null);
  var focusInDropdown = (0, import_react11.useRef)(false);
  var toggle = (0, import_react11.useCallback)(function(nextShow, event) {
  ...
  return import_react11.default.createElement(DropdownContext_default.Provider, {
    value: context
  }, children);
}
...
function useModalManager(provided) {
  ...
  var modal = (0, import_react13.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react13.useCallback)(function(ref) {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react13.useCallback)(function(ref) {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react13.forwardRef)(function(_ref, ref) {
  ...
  var _useState = (0, import_react13.useState)(!show), exited = _useState[0], setExited = _useState[1];
  var lastFocusRef = (0, import_react13.useRef)(null);
  ...
  var removeFocusListenerRef = (0, import_react13.useRef)();
  var removeKeydownListenerRef = (0, import_react13.useRef)();
  ...
  var dialog = renderDialog ? renderDialog(dialogProps) : import_react13.default.createElement("div", dialogProps, import_react13.default.cloneElement(children, {
    role: "document"
  }));
  if (Transition) {
    dialog = import_react13.default.createElement(Transition, {
      appear: true,
      unmountOnExit: true,
      "in": !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition) {
      backdropElement = import_react13.default.createElement(BackdropTransition, {
        appear: true,
        "in": !!show
      }, backdropElement);
    }
  }
  return import_react13.default.createElement(import_react13.default.Fragment, null, import_react_dom2.default.createPortal(import_react13.default.createElement(import_react13.default.Fragment, null, backdropElement, dialog), container));
});
var propTypes4 = {
  /**
...
var Overlay = import_react14.default.forwardRef(function(props, outerRef) {
  ...
  var _useState = (0, import_react14.useState)(!props.show), exited = _useState[0], setExited = _useState[1];
  ...
  if (Transition) {
    ...
    child = import_react14.default.createElement(Transition, {
      "in": props.show,
      appear: true,
      onExit,
      onExiting,
...
var Portal = function Portal2(_ref) {
  ...
  return resolvedContainer ? import_react15.default.createElement(import_react15.default.Fragment, null, import_react_dom4.default.createPortal(children, resolvedContainer)) : null;
};
...
var Toolbar = function(_React$Component) {
  ...
  return _createClass(Toolbar2, [{
    ...
    value: function render() {
      ...
      }, messages2.today), import_react16.default.createElement("button", {
        type: "button",
        onClick: this.navigate.bind(null, navigate.PREVIOUS)
      }, messages2.previous), import_react16.default.createElement("button", {
        type: "button",
        onClick: this.navigate.bind(null, navigate.NEXT)
      }, messages2.next)), import_react16.default.createElement("span", {
        className: "rbc-toolbar-label"
      }, label), import_react16.default.createElement("span", {
        className: "rbc-btn-group"
...
var EventCell = function(_React$Component) {
  ...
  return _createClass(EventCell2, [{
    ...
    value: function render() {
      ...
      var content = import_react16.default.createElement("div", {
        className: "rbc-event-content",
        title: tooltip || void 0
      }, Event2 ? import_react16.default.createElement(Event2, {
        event,
      ...
      return import_react16.default.createElement(EventWrapper, Object.assign({}, this.props, {
        type: "date"
      }), import_react16.default.createElement("div", Object.assign({}, props, {
...
function Pop(_ref2) {
  ...
  return import_react16.default.createElement("div", {
    ...
    return import_react16.default.createElement(EventCell, {
      key: idx,
      type: "popup",
      localizer,
      event,
...
var Popup = import_react16.default.forwardRef(function(props, ref) {
  return import_react16.default.createElement(Pop, Object.assign({}, props, {
    popperRef: ref
  }));
});
Popup.propTypes = {
...
function CalOverlay(_ref) {
  ...
  var popperRef = (0, import_react16.useRef)(null);
  ...
  return import_react16.default.createElement(Overlay_default, {
    rootClose: true,
    flip: true,
    show: true,
    placement: "bottom",
    ...
    return import_react16.default.createElement(Popup, Object.assign({}, props, {
      containerRef,
      ref: popperRef,
      target: overlay.target,
      offset: offset2,
...
var PopOverlay = import_react16.default.forwardRef(function(props, ref) {
  return import_react16.default.createElement(CalOverlay, Object.assign({}, props, {
    containerRef: ref
  }));
});
...
var BackgroundCells = function(_React$Component) {
  function BackgroundCells2(props, context) {
    ...
    _this.containerRef = (0, import_react16.createRef)();
    return _this;
  }
  ...
  return _createClass(BackgroundCells2, [{
    ...
    value: function render() {
      ...
      return import_react16.default.createElement("div", {
        ...
        return import_react16.default.createElement(Wrapper, {
          key: index,
          value: date2,
          range: range2
        }, import_react16.default.createElement("div", {
  ...
  return _createClass(EventEndingRow2, [{
    ...
    value: function renderShowMore(segments, slot) {
      ...
      if (components2 !== null && components2 !== void 0 && components2.showMore) {
        ...
        return count ? import_react16.default.createElement(ShowMore, {
          localizer,
          slotDate,
          slot,
          count,
      ...
      return count ? import_react16.default.createElement("button", {
        type: "button",
        key: "sm_" + slot,
...
var DateContentRow = function(_React$Component) {
  function DateContentRow2() {
    ...
    _this.renderDummy = function() {
      ...
      }, renderHeader && import_react16.default.createElement("div", {
        className: "rbc-row",
        ref: _this.headingRowRef
      }, range2.map(_this.renderHeadingCell)), import_react16.default.createElement("div", {
        className: "rbc-row",
    ...
    _this.containerRef = (0, import_react16.createRef)();
    _this.headingRowRef = (0, import_react16.createRef)();
    _this.eventRowRef = (0, import_react16.createRef)();
  ...
  return _createClass(DateContentRow2, [{
    ...
    value: function render() {
      ...
      return import_react16.default.createElement("div", {
        ...
        role: "rowgroup",
        ref: this.containerRef
      }, import_react16.default.createElement(BackgroundCells, {
        localizer,
        date: date2,
        getNow: getNow2,
        rtl,
      ...
      }, range2.map(this.renderHeadingCell)), import_react16.default.createElement(ScrollableWeekComponent, null, import_react16.default.createElement(WeekWrapper, Object.assign({
        isAllDay
      }, eventRowProps, {
        rtl: this.props.rtl
      }), levels.map(function(segs, idx) {
        return import_react16.default.createElement(EventRow, Object.assign({
          key: idx,
          segments: segs
        }, eventRowProps));
      }), !!extra.length && import_react16.default.createElement(EventEndingRow, Object.assign({
        segments: extra,
...
var DateHeader = function DateHeader2(_ref) {
  ...
  if (!drilldownView) {
    return import_react16.default.createElement("span", null, label);
  }
  return import_react16.default.createElement("button", {
    type: "button",
...
var MonthView = function(_React$Component) {
  function MonthView2() {
    ...
    _this.renderWeek = function(week, weekIdx) {
      ...
      return import_react16.default.createElement(DateContentRow, {
        key: weekIdx,
    ...
    _this.readerDateHeading = function(_ref) {
      ...
      return import_react16.default.createElement("div", Object.assign({}, props, {
        className: clsx_m_default(className, isOffRange && "rbc-off-range", isCurrent && "rbc-current"),
        role: "cell"
      }), import_react16.default.createElement(DateHeaderComponent, {
        label,
        date: date2,
        drilldownView,
        isOffRange,
    ...
    _this.containerRef = (0, import_react16.createRef)();
    _this.slotRowRef = (0, import_react16.createRef)();
    _this._bgRows = [];
  ...
  return _createClass(MonthView2, [{
    ...
    value: function renderHeaders(row) {
      ...
      return localizer.range(first, last, "day").map(function(day2, idx) {
        ...
        }, import_react16.default.createElement(HeaderComponent, {
          date: day2,
          localizer,
    ...
    value: function renderOverlay() {
      ...
      return import_react16.default.createElement(PopOverlay, {
        overlay,
        accessors,
        localizer,
        components: components2,
...
var TimeSlotGroup = function(_Component) {
  ...
  return _createClass(TimeSlotGroup2, [{
    ...
    value: function render() {
      ...
      return import_react16.default.createElement("div", Object.assign({
        ...
        return import_react16.default.createElement(Wrapper, {
          ...
          value,
          resource
        }, import_react16.default.createElement("div", Object.assign({}, slotProps, {
...
function TimeGridEvent(props) {
  ...
  var start = accessors.start(event);
  var userProps = getters.eventProp(event, start, end, selected);
  var inner = [import_react16.default.createElement("div", {
    key: "1",
    className: "rbc-event-label"
  }, label), import_react16.default.createElement("div", {
    key: "2",
    className: "rbc-event-content"
  }, Event2 ? import_react16.default.createElement(Event2, {
    event,
  ...
  return import_react16.default.createElement(EventWrapper, Object.assign({
    type: "time"
  }, props), import_react16.default.createElement("div", {
    role: "button",
    tabIndex: 0,
    onClick,
    onDoubleClick,
...
var DayColumnWrapper$1 = import_react16.default.forwardRef(function(props, ref) {
  return import_react16.default.createElement(DayColumnWrapper, Object.assign({}, props, {
    innerRef: ref
  }));
});
...
var DayColumn = function(_React$Component) {
  function DayColumn2() {
    ...
    _this.renderEvents = function(_ref) {
      ...
      return styledEvents.map(function(_ref2, idx) {
        ...
        return import_react16.default.createElement(TimeGridEvent, {
          style,
          event,
          label,
          key,
  ...
  return _createClass(DayColumn2, [{
    ...
    value: function render() {
      ...
      var _dayProp = dayProp(max2, resource), className = _dayProp.className, style = _dayProp.style;
      ...
      return import_react16.default.createElement(DayColumnWrapperComponent, {
        ref: this.containerRef,
        date: date2,
        style,
        className: clsx_m_default(
        ...
        return import_react16.default.createElement(TimeSlotGroup, {
          key: idx,
          group: grp,
          resource,
          getters,
      ...
      }), import_react16.default.createElement(EventContainer, {
        localizer,
        resource,
        accessors,
        getters,
      ...
      }))), selecting && import_react16.default.createElement("div", {
        className: "rbc-slot-selection",
        style: {
          top,
          height: height2
        }
      }, import_react16.default.createElement("span", null, localizer.format(selectDates, "selectRangeFormat"))), isNow && this.intervalTriggered && import_react16.default.createElement(TimeIndicatorWrapper, timeIndicatorProps, import_react16.default.createElement("div", timeIndicatorProps)));
    }
  }]);
}(import_react16.default.Component);
...
var ResourceHeader = function ResourceHeader2(_ref) {
  var label = _ref.label;
  return import_react16.default.createElement(import_react16.default.Fragment, null, label);
};
  ...
  return _createClass(TimeGridHeader2, [{
    ...
    value: function renderHeaderCells(range2) {
      ...
      return range2.map(function(date2, i) {
        ...
        var header = import_react16.default.createElement(HeaderComponent, {
          date: date2,
          label,
          localizer
        });
        ...
        }, drilldownView ? import_react16.default.createElement("button", {
          type: "button",
          className: "rbc-button-link",
          onClick: function onClick(e) {
            return _this2.handleHeaderClick(date2, drilldownView, e);
          }
        }, header) : import_react16.default.createElement("span", null, header));
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, TimeGutterHeader && import_react16.default.createElement(TimeGutterHeader, null)), resources.map(function(_ref, idx) {
        var _ref2 = _slicedToArray(_ref, 2), id = _ref2[0], resource = _ref2[1];
        return import_react16.default.createElement("div", {
          className: "rbc-time-header-content",
          key: id || idx
        }, resource && import_react16.default.createElement("div", {
          className: "rbc-row rbc-row-resource",
          key: "resource_".concat(idx)
        }, import_react16.default.createElement("div", {
          className: "rbc-header"
        }, import_react16.default.createElement(ResourceHeaderComponent, {
          index: idx,
          label: accessors.resourceTitle(resource),
          resource
        }))), import_react16.default.createElement("div", {
          className: "rbc-row rbc-time-header-cell".concat(range2.length <= 1 ? " rbc-time-header-cell-single-day" : "")
        }, _this3.renderHeaderCells(range2)), import_react16.default.createElement(DateContentRow, {
          isAllDay: true,
          rtl,
          getNow: getNow2,
          minRows: 2,
  ...
  return _createClass(TimeGridHeaderResources2, [{
    ...
    value: function renderHeaderCells(range2) {
      ...
      return range2.map(function(date2, idx) {
        ...
        }, header) : import_react16.default.createElement("span", null, header))), import_react16.default.createElement("div", {
          className: "rbc-row"
    ...
    value: function render() {
      ...
      }, TimeGutterHeader && import_react16.default.createElement(TimeGutterHeader, null)), this.renderHeaderCells(range2));
    }
  }]);
}(import_react16.default.Component);
...
var TimeGutter = function TimeGutter2(_ref2) {
  ...
  var _useMemo = (0, import_react16.useMemo)(
    function() {
      return adjustForDST({
        min: min2,
        max: max2,
  ...
  var _useState = (0, import_react16.useState)(getSlotMetrics({
    min: start,
    max: end,
    timeslots,
    step,
  ...
  var renderSlot = (0, import_react16.useCallback)(function(value, idx) {
    if (idx) return null;
  ...
  return import_react16.default.createElement(TimeGutterWrapper, {
    slotMetrics
  }, import_react16.default.createElement("div", {
...
var TimeGutter$1 = import_react16.default.forwardRef(function(props, ref) {
  return import_react16.default.createElement(TimeGutter, Object.assign({
    gutterRef: ref
  }, props));
});
var NONE = {};
...
var TimeGrid = function(_Component) {
  function TimeGrid2(props) {
    ...
    _this.scrollRef = import_react16.default.createRef();
    _this.contentRef = import_react16.default.createRef();
    _this.containerRef = import_react16.default.createRef();
    _this._scrollRatio = null;
    _this.gutterRef = (0, import_react16.createRef)();
    return _this;
  }
  ...
  return _createClass(TimeGrid2, [{
    ...
    value: function renderDayColumn(date2, id, resource, groupedEvents, groupedBackgroundEvents, localizer, accessors, components2, dayLayoutAlgorithm, now) {
      ...
      return import_react16.default.createElement(DayColumn, Object.assign({}, this.props, {
        localizer,
    ...
    value: function render() {
      ...
      return import_react16.default.createElement("div", {
        ...
        ref: this.containerRef
      }, resources && resources.length > 1 && resourceGroupingLayout ? import_react16.default.createElement(TimeGridHeaderResources, headerProps) : import_react16.default.createElement(TimeGridHeader, headerProps), this.props.popup && this.renderOverlay(), import_react16.default.createElement("div", {
        ref: this.contentRef,
        className: "rbc-time-content",
        onScroll: this.handleScroll
      }, import_react16.default.createElement(TimeGutter$1, {
        date: start,
        ref: this.gutterRef,
        localizer,
...
var Day = function(_React$Component) {
  ...
  return _createClass(Day2, [{
    ...
    value: function render() {
      ...
      return import_react16.default.createElement(TimeGrid, Object.assign({}, props, {
        range: range2,
        eventOffset: 10,
        localizer,
        min: min2,
...
function Agenda(_ref) {
  ...
  var headerRef = (0, import_react16.useRef)(null);
  var dateColRef = (0, import_react16.useRef)(null);
  var timeColRef = (0, import_react16.useRef)(null);
  var contentRef = (0, import_react16.useRef)(null);
  var tbodyRef = (0, import_react16.useRef)(null);
  (0, import_react16.useEffect)(function() {
    _adjustHeader();
  });
  var renderDay = function renderDay2(day2, events2, dayKey) {
    ...
    return events2.map(function(event, idx) {
      ...
      var first = idx === 0 ? import_react16.default.createElement("td", {
        rowSpan: events2.length,
        className: "rbc-agenda-date-cell"
      }, AgendaDate ? import_react16.default.createElement(AgendaDate, {
        day: day2,
        label: dateLabel
      }) : dateLabel) : false;
      return import_react16.default.createElement("tr", {
        key: dayKey + "_" + idx,
        className: userProps.className,
        style: userProps.style
      }, first, import_react16.default.createElement("td", {
        className: "rbc-agenda-time-cell"
      }, timeRangeLabel(day2, event)), import_react16.default.createElement("td", {
  ...
  var timeRangeLabel = function timeRangeLabel2(day2, event) {
    ...
    }, TimeComponent ? import_react16.default.createElement(TimeComponent, {
      event,
      day: day2,
      label
    }) : label);
  ...
  }, events.length !== 0 ? import_react16.default.createElement(import_react16.default.Fragment, null, import_react16.default.createElement("table", {
    ref: headerRef,
    className: "rbc-agenda-table"
  }, import_react16.default.createElement("thead", null, import_react16.default.createElement("tr", null, import_react16.default.createElement("th", {
    className: "rbc-header",
    ref: dateColRef
  }, messages2.date), import_react16.default.createElement("th", {
    className: "rbc-header",
    ref: timeColRef
  }, messages2.time), import_react16.default.createElement("th", {
    className: "rbc-header"
  }, messages2.event)))), import_react16.default.createElement("div", {
    className: "rbc-agenda-content",
    ref: contentRef
  }, import_react16.default.createElement("table", {
    className: "rbc-agenda-table"
  }, import_react16.default.createElement("tbody", {
    ref: tbodyRef
...
var Calendar = function(_React$Component) {
  ...
  return _createClass(Calendar2, [{
    ...
    value: function render() {
      ...
      return import_react16.default.createElement("div", Object.assign({}, elementProps, {
        className: clsx_m_default(className, "rbc-calendar", props.rtl && "rbc-rtl"),
        style
      }), toolbar && import_react16.default.createElement(CalToolbar, {
        date: current,
        view,
        views: viewNames2,
        label,
        ...
        localizer
      }), import_react16.default.createElement(View, Object.assign({}, props, {
        events,
        backgroundEvents,
        date: current,
        getNow: getNow2,
